...
static constexpr const char* typeRecoveryRequestState = "engine.recoveryRequestState";
static constexpr const char* typeRecoveryState = "engine.recoveryState";
static constexpr const char* typeRecovered = "engine.recovered";
static constexpr const char* typeRenderRequestState = "render.requestState";
static constexpr const char* typeRenderState = "render.state";
static constexpr const char* typeRenderFullMix = "render.fullMix";
static constexpr const char* typeRenderStems = "render.stems";
static constexpr const char* typeRenderCompleted = "render.completed";
...
static constexpr const char* typeClockDomainsSetRelation = "clockdomains.setRelation";
static constexpr const char* typeClockDomainsRelationChanged = "clockdomains.relationChanged";
static constexpr const char* typeClockDomainsRelationRejected = "clockdomains.relationRejected";
...
static constexpr const char* typeMixerAssignGroup = "mixer.assignGroup";
static constexpr const char* typeMixerSetSendLevel = "mixer.setSendLevel";
static constexpr const char* typeMixerSetSendMode = "mixer.setSendMode";
...
static constexpr const char* typeRegionsCreateLiveLinked = "regions.createLiveLinked";
...
static constexpr const char* typeStructuralRequestState = "structural.requestState";
static constexpr const char* typeStructuralState = "structural.state";
static constexpr const char* typeStructuralScheduleSceneTransition = "structural.scheduleSceneTransition";
static constexpr const char* typeStructuralSceneTransitionScheduled = "structural.sceneTransitionScheduled";
static constexpr const char* typeStructuralSceneTransitionApplied = "structural.sceneTransitionApplied";
static constexpr const char* typeStructuralSceneTransitionRejected = "structural.sceneTransitionRejected";
static constexpr const char* typeStructuralExternalCue = "structural.externalCue";
static constexpr const char* typeStructuralExternalCueReceived = "structural.externalCueReceived";
static constexpr const char* typePerformanceRequestState = "performance.requestState";
static constexpr const char* typePerformanceState = "performance.state";
static constexpr const char* typePerformanceTriggerMacro = "performance.triggerMacro";
static constexpr const char* typePerformanceMacroTriggered = "performance.macroTriggered";
static constexpr const char* typePerformanceError = "performance.error";
static constexpr const char* typeAnalysisRequestState = "analysis.requestState";
static constexpr const char* typeAnalysisState = "analysis.state";
